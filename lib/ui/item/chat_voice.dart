...
class _ChatVoiceWidgetState extends State<ChatVoice> {
  ...
  void initState() {
    ...
    // flutterSound.setDbLevelEnabled(true);
     flutterSound.setSubscriptionDuration(Duration(milliseconds: 30));
  ...
  void start() async {
    ...
    try {
      ...
      showToast(context, 'startRecorder error: ${err.message}');
    }
  }
  ...
  void stop() async {
    try {
      ...
      showToast(context, 'stopRecorder error: ${err.message}');
    }
  }
